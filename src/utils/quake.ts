import { QuakeParams } from '@/store/quake_params';
import { AnimParams } from '@/store/anim_params';
...
function processQuakes(quakes: Quake[], animParams: AnimParams): { quakes: Quake[], qParams: QuakeParams } {
...
export function calculatePositions(qList: Quake[], animParams: AnimParams): QuakeParams {
	const params: any = {};
	let M = 0;
